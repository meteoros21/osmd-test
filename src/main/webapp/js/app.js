(async () => {
    ...
    //const url = "https://opensheetmusicdisplay.github.io/demo/sheets/MuzioClementi_SonatinaOpus36No3_Part1.xml";
    const url = "/data/MuzioClementi_SonatinaOpus36No3_Part1.xml";
